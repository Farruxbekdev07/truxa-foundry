...
const roles = [
  {
    ...
    description:
      "Validate your startup idea with AI-powered insights and connect with the right people to scale.",
    features: [
  ...
  },
  {
    ...
    description:
      "Discover data-validated startups with clear metrics and direct access to founders.",
    features: [
      "Pre-validated startups",
  ...
  },
  {
    ...
    description:
      "Guide startups with AI-supported insights and make a lasting impact on the ecosystem.",
    features: [
      "Matched mentoring",
      "AI-backed guidance",
      "Track impact",
  ...
  },
  {
    ...
    description:
      "Join validated startups at the right stage and grow your career with equity opportunities.",
    features: [
      "Validated startups only",
      "Clear growth stage",
      ...
      <Container maxWidth="lg">
        <Box className="text-center mb-16">
          ...
          <Box className="flex justify-center mt-4">
            ...
            >
              Whether you're building, investing, mentoring, or coding — Truxa
              Foundry has the tools you need.
            </Typography>
          </Box>
        </Box>
