...
const steps = [
  ...
  },
  {
    ...
    description:
      "Tell us about your startup, target market, problem you're solving, and your solution.",
  },
  {
    step: "03",
    icon: Sparkles,
    title: "AI Analysis",
    description:
      "Our AI instantly analyzes your profile against market data and success patterns.",
  },
  {
    step: "04",
    icon: BarChart3,
    ...
    description:
      "Receive your PMF score, growth strategy, and specific recommendations to improve.",
  },
];
